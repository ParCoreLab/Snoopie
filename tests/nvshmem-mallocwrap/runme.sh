...
# TOOL_VERBOSE=1 KERNEL_NAME="ncclKernel_SendRecv_RING_SIMPLE_Sum_int8_t" LD_PRELOAD="$HOME/proj/nvbit/nvbit_release/src/mem_multigpu/libmem_multigpu.so" ./main2


# mpirun -x LD_PRELOAD="/home/missa18/proj/nvbit/nvbit_release/tools/cudaops/cudaops.so" -np 4 ./main
mpirun -x KERNEL_NAME="void nvshmemi_transfer_rma_p<int>" -x LD_PRELOAD="../../src/mem_multigpu/libmem_multigpu.so" -np 2 ./main

__global__ void kernel_cuda_simple(int *v_adj_list, int *v_adj_begin,
                                   int *v_adj_length, int num_vertices,
                                   int *result, bool *still_running) {
...
int bfs_cuda_simple(int *v_adj_list, int *v_adj_begin, int *v_adj_length,
  ...
  do {
    ...
    kernel_cuda_simple<<<BLOCKS, THREADS>>>(k_v_adj_list, k_v_adj_begin,
                                            k_v_adj_length, num_vertices,
                                            k_result, k_still_running);

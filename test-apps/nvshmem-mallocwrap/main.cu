...
int main (int argc, char *argv[]) {
    ...
    fprintf(stderr, "the offset of destination is %lx in process %d\n", (unsigned long) destination, mype_node);
    ...
    fprintf(stderr, "the offset of aligned_var is %lx in process %d\n", (unsigned long) aligned_var, mype_node);

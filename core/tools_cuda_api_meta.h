...
// CU_TOOLS_FOR_EACH_CUDA_API_FUNC allows you to generate code to do an action
// for every function in the CUDA API, or every function included in the current
// build.
//
// "ACTION" is macro function to apply to the metadata for all CUDA API
// functions. The ACTION must take four parameters:
//     - An "area" which is just a #define for specifying inclusion in the
//     results
//       of SupportedCallbacksInDomain().  For example, if you specify an area
//       "foo" for a set of functions, you must #define SUPPORT_FOR_foo TRUE on
//       platforms that support these functions, and #define SUPPORT_FOR_foo
//       FALSE on platforms that do not support them.  If a function is ever
//       removed, specify REMOVED for its area.
...
// sequence of cbids.  You will get a compile error if you skip or reorder
// cbids.
//
